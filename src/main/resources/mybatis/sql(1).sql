...
-- Records of customer
-- ----------------------------
INSERT INTO `customer` VALUES ('1', 'hxy', '12345', '5A124', '123456', '1');
...
-- Records of order_
-- ----------------------------
INSERT INTO `order_` VALUES ('1', '202310021055177112826', '5a124', '2', '1');
INSERT INTO `order_` VALUES ('2', '202311021055179112826', '我是地址', '2', '1');
INSERT INTO `order_` VALUES ('18', '202312051731209717398', '姓名：hxy,邮箱：2474353483@qq.com,配送地址：学18号楼420室,手机号：123456', '1', '1');
INSERT INTO `order_` VALUES ('19', '202312111750178958169', '姓名：gsk,邮箱：11001101100@qq.com,配送地址：综合楼101室,手机号：123456', '1', '1');
...
INSERT INTO `product` VALUES ('13', '初见', '105.00', '124', '234', '1', 'images/product/13.jpg', '人生若只如初见，薛老师我们都很爱', '2', '31');
INSERT INTO `product` VALUES ('14', '香辣鸡腿堡', '5.00', '124', '254', '1', 'images/product/14.jpg', '开业特惠，豪吃不贵！限时特价商品', '3', '31');
INSERT INTO `product` VALUES ('15', '墨西哥鸡肉卷', '19.00', '453', '454', '1', 'images/product/15.jpg', '里面用的是番茄酱哈', '3', '31');
INSERT INTO `product` VALUES ('16', '爆浆鸡排', '12.00', '45', '4654', '1', 'images/product/16.jpg', '香脆可口', '3', '31');
INSERT INTO `product` VALUES ('17', '椰奶芝士蛋糕', '11.00', '54', '132', '1', 'images/product/17.jpg', '香甜可口，吃完还想吃', '3', '31');
INSERT INTO `product` VALUES ('18', '南瓜脆皮芝士包', '8.00', '15', '232', '1', 'images/product/18.jpg', '送女朋友必备，没有女朋友的鉴定为没有准备这个', '3', '31');
INSERT INTO `product` VALUES ('19', '鸡汤来喽', '23.00', '33', '323', '1', 'images/product/19.jpg', '大厨亩斯专为软件师生的冬日特别定制，暖暖的很贴心', '3', '30');
INSERT INTO `product` VALUES ('20', '炒饭', '45.00', '45', '555', '1', 'images/product/20.jpg', '把简单的事情做到不简单，这就是我们存在的意义。优质猪后腿肉，在浓郁的老卤的怀抱中千回百转。30余味的精选香料与肉块的完美融合。', '4', '30');
INSERT INTO `product` VALUES ('25', '海鲜捞面', '42.00', '444', '444', '1', 'images/product/25.jpg', '海鲜拌面的plus版', '4', '30');
INSERT INTO `product` VALUES ('26', '菜花配毛豆', '35.00', '23', '43', '1', 'images/product/26.jpg', '菜花+毛豆+亩斯放的胡萝卜丁', '4', '30');
INSERT INTO `product` VALUES ('27', '培根披萨', '25.00', '34', '53', '1', 'images/product/27.jpg', '培根+火腿+芝士+披萨饼', '4', '30');
INSERT INTO `product` VALUES ('28', '海鲜拌面', '23.00', '34', '23', '1', 'images/product/28.jpg', '新鲜大虾配上炸爽的料汁是大厨许的又一得意之作', '4', '30');
INSERT INTO `product` VALUES ('29', '西红柿炒鸡蛋', '23.00', '43', '65', '1', 'images/product/29.jpg', '家常菜在许大厨的烹饪下无敌了', '4', '30');
INSERT INTO `product` VALUES ('30', '老北京炸酱面', '98.00', '456', '998', '1', 'images/product/30.jpg', '3.老北京必吃，没吃过不算北京爷', '5', '31');
INSERT INTO `product` VALUES ('31', '馄饨', '45.00', '98', '564', '1', 'images/product/31.jpg', '你觉得和云吞有什么区别', '6', '29');
...
-- Records of review
-- ----------------------------
INSERT INTO `review` VALUES ('3', '我是评论', '1', '4', '2023-12-04 10:52:37');
INSERT INTO `review` VALUES ('4', 'w is pl ', '1', '5', '2023-12-04 10:54:24');
INSERT INTO `review` VALUES ('6', 'aa', '1', '4', '2023-12-05 17:15:37');
INSERT INTO `review` VALUES ('7', '我是一条评论', '1', '4', '2023-12-05 17:50:33');
INSERT INTO `review` VALUES ('8', 'kl0', '1', '4', '2023-12-07 20:38:35');
INSERT INTO `review` VALUES ('9', null, '1', '4', '2023-12-07 09:36:30');
INSERT INTO `review` VALUES ('10', 'pjia ', '1', '4', '2023-12-08 09:38:49');
INSERT INTO `review` VALUES ('11', '我是评价', '1', '2', '2023-12-09 09:41:12');
INSERT INTO `review` VALUES ('12', '测试评价', '1', '10', '2023-12-09 16:32:08');
...
-- Records of user
-- ----------------------------
INSERT INTO `user` VALUES ('1', '小白', '74c5777c983c8be3d4b1f02f5b7f9914', 'nTBxvvDBZuQ+FzZf5qmaZQ==', '1', '暂无', '12445242532', '2023-12-01 21:56:42');
INSERT INTO `user` VALUES ('15', 'visitor', '6367dbed6a55839758cfb67771973841', 'CKebgOQhmZkLrBYXtBOLbQ==', '1', '暂无', '12456458532', '2023-12-01 11:29:41');
INSERT INTO `user` VALUES ('28', '避风港', '552b3a7761fc3a9d1f0db4472ab30d51', '2i/lq3CinJJBGKWc7oU/JQ==', '1', '三楼02号窗口', '18224235623', '2023-12-01 11:25:22');
INSERT INTO `user` VALUES ('29', '小熊早餐', '8612e72664be9722e41a81ac0aaa0fd6', 'mHnsr5dIoQKC2DQzvHRrRg==', '1', '四楼01号窗口', '12453265428', '2023-12-01 09:17:27');
INSERT INTO `user` VALUES ('30', '美味私厨', 'a469aeda72843f96fc68bc6d63c3dcca', '4PM6lket6jMAYk3/wHLF/Q==', '1', '三楼02号窗口', '15684569753', '2023-12-01 09:17:27');
INSERT INTO `user` VALUES ('31', '川西食府', '711fc51f8cc005bcf255805f91390e0b', '6h4fM4l6AnPKZiLQHwxZQA==', '1', '四楼03号窗口', '12452253264', '2023-12-01 09:17:27');
...
-- Records of news
-- ----------------------------
INSERT INTO `news` VALUES ('1', '我是第一条资讯', '1', '1', '2023-12-05 14:53:29');
INSERT INTO `news` VALUES ('2', '我是第二个', '1', '1', '2023-12-05 18:05:42');
INSERT INTO `news` VALUES ('3', 'aaaa', '1', '1', '2023-12-06 15:06:38');
INSERT INTO `news` VALUES ('4', '我是一条没审核的资讯', '1', '0', '2023-12-06 15:20:07');
INSERT INTO `news` VALUES ('6', '我想发布一条资讯', '1', '1', '2023-12-26 11:19:57');
